...
export default function LandingPage() {
    ...
    // Splitting FAQs into two separate lists based on the role
    const brandFaqs = [
        "How do I manage multiple creators efficiently?",
        "What metrics are tracked within the platform?",
        "Is the payment escrow system safe and automated?",
        "Can I request revisions before releasing funds?"
    ];

    const creatorFaqs = [
        "How do I get discovered by top brands?",
        "When and how do I get paid?",
        "Do I have to accept every brand offer?",
        "Are my social media analytics secure?"
    ];
    ...
    return (
        <div className="min-h-screen bg-[#F8F9FA] relative overflow-hidden font-sans text-gray-900">
            ...
            <header className="fixed w-full top-0 z-50 backdrop-blur-md bg-white/95 border-b border-gray-100/50 shadow-sm transition-all">
                <div className="max-w-[90rem] mx-auto px-6 py-4 flex items-center gap-10">
                    <Link href="/">
                        <Image 
            ...
            <main className="w-full max-w-[90rem] mx-auto px-6 relative z-10 pt-24">
                ...
                <ScrollReveal>
                    <section className="pt-12 pb-16 md:pt-16 md:pb-24 flex flex-col lg:flex-row items-center justify-between gap-12">
                        ...
                        {/* Hero Images - Hidden on mobile, solid colors */}
                        <div className="hidden md:flex flex-1 justify-center lg:justify-end gap-4 relative h-[450px] w-full max-w-md">
                    ...
                    <section className="py-16 md:py-20">
                        ...
                        <div className="flex flex-col md:flex-row items-center justify-between w-full max-w-5xl mx-auto gap-12 mb-16 md:mb-24">
                            ...
                            <div className="flex-1 w-full relative bg-indigo-50/50 rounded-2xl shadow-xl aspect-[4/3] overflow-hidden">
                                <Image src="/images/LandingImage3.png" alt="Dashboard Data" fill className="object-contain" />
                            </div>
                        </div>
                        ...
                        <div className="flex flex-col md:flex-row-reverse items-center justify-between w-full max-w-5xl mx-auto gap-12 mb-16 md:mb-24">
                            ...
                            <div className="flex-1 w-full relative rounded-2xl shadow-xl aspect-[4/3] overflow-hidden">
                                <Image src="/images/LandingImage4.png" alt="Messaging UI" fill className="object-contain" />
                            </div>
                        </div>
                        ...
                        <div className="flex flex-col md:flex-row items-center justify-between w-full max-w-5xl mx-auto gap-12">
                            ...
                            <div className="flex-1 w-full relative rounded-2xl shadow-xl aspect-[4/3] overflow-hidden p-6">
                                <Image src="/images/LandingImage5.png" alt="Escrow Graphic" fill className="object-contain" />
                            </div>
                        </div>
                    </section>
                </ScrollReveal>
