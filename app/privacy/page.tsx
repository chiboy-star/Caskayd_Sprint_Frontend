...
export const metadata = {
  title: "Privacy Policy | Caskayd",
  description: "Learn how Caskayd collects, utilizes, and protects your personal data in accordance with the Nigeria Data Protection Act (NDPA) 2023.",
};
    ...
    <div className="min-h-screen bg-gray-50 py-16 px-6 lg:px-8 font-sans">
      <div className="max-w-3xl mx-auto bg-white p-8 md:p-12 rounded-2xl shadow-sm border border-gray-100">
        ...
        <div className="mb-10 border-b border-gray-100 pb-8">
            <Link href="/" className="text-emerald-600 hover:text-emerald-700 font-semibold text-sm mb-6 inline-block">
                &larr; Back to Home
            </Link>
